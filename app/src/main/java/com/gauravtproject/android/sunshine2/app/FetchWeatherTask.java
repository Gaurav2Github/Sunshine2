...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(locationCursor.moveToFirst()){
            ...
            //Create content Values object to hold the datat to insert.
            ContentValues locationValues = new ContentValues();

            //Then add the data, along with teh corresponding name of data type,
            ...
            // Finally insert location datat to the database.
            Uri insertUri = mContext.getContentResolver().insert(
                    WeatherContract.LocationEntry.CONTENT_URI,
                    locationValues );

            //Extracting the locationId from THe Uri.
